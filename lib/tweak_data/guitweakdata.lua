...
function GuiTweakData:_setup_icons()
	...
	self.icons.raid_oops_logo_small = {
		texture = "ui/updates/upd_oops/update_logo",
		texture_rect = {
			0,
			0,
			833,
	...
	self.icons.card_type_bounty = {
		texture = "ui/updates/upd_cow/cc_menu_tags_bounty",
		texture_rect = {
			0,
			0,
			64,
	...
	self.icons.menu_item_resume = {
		texture = "ui/atlas/menu/raid_atlas_menu_icons",
		texture_rect = {
			0,
			2,
			28,
	...
	self.icons.missions_raid_bounty_menu = {
		texture = "ui/updates/upd_cow/job_icons",
		texture_rect = {
			384,
			0,
			56,
...
function GuiTweakData:_setup_map_icons()
	...
	self.icons.map_forest_bunker = {
		texture = "ui/missions/forest_bunker/map_forest_bunker",
		texture_rect = {
			0,
			0,
			1024,
	...
	self.icons.map_forest_bunker_int = {
		texture = "ui/missions/forest_bunker/map_forest_bunker_int",
		texture_rect = {
			0,
			0,
			1024,
...
function GuiTweakData:_setup_mission_photos()
	...
	self.mission_photos.intel_forest_bunker_01 = {
		texture = "ui/missions/forest_bunker/raid_atlas_photos_forest_bunker",
		texture_rect = {
			2,
			2,
			416,
	...
	self.mission_photos.intel_random_operation_01 = {
		texture = "ui/updates/upd_oops/raid_atlas_photos_random_operation",
		texture_rect = {
			2,
			2,
			416,
