...
XB1SelectUserDialog = XB1SelectUserDialog or class(SelectUserDialog)

function XB1SelectUserDialog:init(manager, data)
...
function XB1SelectUserDialog:show()
	...
	print("[XB1SelectUserDialog:show] wrapper_index", wrapper_index, "controller_index", controller_index, "controller:type()", controller:type())
...
function XB1SelectUserDialog:update(t, dt)
...
function XB1SelectUserDialog:done_callback()
	self._show_time = nil
