...
function SlotManager:init()
	...
	C_UnitManager:set_slot_limited(14, 100)
	C_UnitManager:set_slot_infinite(16)
	C_UnitManager:set_slot_infinite(17)
	C_UnitManager:set_slot_limited(18, 30)
	C_UnitManager:set_slot_limited(20, 100)
	C_UnitManager:set_slot_infinite(21)
	C_UnitManager:set_slot_infinite(23)
	...
	self._masks.all_criminals = World:make_slot_mask(2, 3, 5, 16, 24, 25)
	self._masks.all_criminals_no_player = World:make_slot_mask(2, 3, 4, 5)
	...
	self._masks.trip_mine_targets = World:make_slot_mask(12, 21, 33)
	self._masks.betty_mine_targets = World:make_slot_mask(12, 21, 25, 33)
	self._masks.cameras = World:make_slot_mask(7)
	self._masks.enemies = World:make_slot_mask(12, 33)
	self._masks.persons = World:make_slot_mask(2, 3, 4, 5, 12, 16, 21, 24, 33)
	...
	self._masks.bullet_impact_targets = World:make_slot_mask(1, 2, 8, 11, 12, 14, 16, 17, 18, 21, 25, 26, 33, 34, 35, 39)
	...
	self._masks.bullet_impact_targets_sentry_gun = World:make_slot_mask(1, 8, 11, 12, 14, 17, 33, 34, 35, 39)
	self._masks.bullet_impact_targets_no_AI = World:make_slot_mask(1, 2, 8, 11, 14, 17, 33, 34, 35, 39)
	self._masks.bullet_impact_targets_shooting_death = World:make_slot_mask(1, 8, 11, 12, 14, 17, 21, 33, 34, 35)
	...
	self._masks.arrow_impact_targets = World:make_slot_mask(1, 2, 8, 11, 12, 16, 17, 18, 21, 25, 26, 33, 34, 35, 39)
	...
	self._masks.flesh = World:make_slot_mask(12, 16, 17, 21, 24, 33)
